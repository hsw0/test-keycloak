...
REVOKE ALL ON DATABASE "{{ radius_db_database }}" FROM "public";
GRANT CONNECT ON DATABASE "{{ radius_db_database }}" TO "{{ radius_db_username }}";

REVOKE ALL ON SCHEMA "public" FROM "public";
GRANT USAGE ON SCHEMA "public" TO "{{ radius_db_username }}";
...
https://github.com/FreeRADIUS/freeradius-server/blob/release_3_0_16/raddb/mods-config/sql/main/postgresql/schema.sql
https://github.com/FreeRADIUS/freeradius-server/blob/release_3_0_16/raddb/mods-config/sql/main/postgresql/setup.sql
*/
 ...
 */
GRANT SELECT ON radcheck TO "{{ radius_db_username }}";
GRANT SELECT ON radreply TO "{{ radius_db_username }}";
GRANT SELECT ON radgroupcheck TO "{{ radius_db_username }}";
GRANT SELECT ON radgroupreply TO "{{ radius_db_username }}";
GRANT SELECT ON radusergroup TO "{{ radius_db_username }}";
GRANT SELECT ON nas TO "{{ radius_db_username }}";

/*
 * The server can write to the accounting and post-auth logging table.
 */
GRANT SELECT, INSERT, UPDATE on radacct TO "{{ radius_db_username }}";
GRANT SELECT, INSERT, UPDATE on radpostauth TO "{{ radius_db_username }}";

/*
 * Grant permissions on sequences
 */
GRANT USAGE, SELECT ON SEQUENCE nas_id_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radacct_radacctid_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radcheck_id_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radgroupcheck_id_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radgroupreply_id_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radpostauth_id_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radreply_id_seq TO "{{ radius_db_username }}";
GRANT USAGE, SELECT ON SEQUENCE radusergroup_id_seq TO "{{ radius_db_username }}";
